 ...
 */
@Component
public class OffsetConsumerByJason {
    private static final Logger log = LoggerFactory.getLogger(OffsetConsumerByJason.class);

    @Component
    @RocketMQMessageListener(topic = "topic-offset-by-jason", consumerGroup = "topic-offset-by-jason-consumer")
    public class OfferConsumerBy implements RocketMQListener<Message>, RocketMQPushConsumerLifecycleListener {
        ...
        public void onMessage(Message message) {
            ...
            log.info("topic-offset-by-jason: {}", new String(message.getBody()));

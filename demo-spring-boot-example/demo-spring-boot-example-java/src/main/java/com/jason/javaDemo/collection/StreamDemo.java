package com.jason.javaDemo.collection;

import com.jason.javaDemo.collection.domain.Person;
import com.jason.javaDemo.collection.domain.Pig;
...
public class StreamDemo {
    ...
    public static void testStreamSort() {
        ...
        User jason = new User(1, "jason", 12);
        User jason1 = new User(2, "jason1", 123);
        User jason2 = new User(3, "jason2", 124);
        users.add(jason2);
        users.add(jason1);
        users.add(jason);
        //普通的排序取值

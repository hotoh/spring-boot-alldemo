...
import com.jason.domain.OrderData;
import com.jason.domain.Product;
import com.jason.read.IndexOrNameDataListener;
import com.jason.strategy.CustomMergeStrategy;
import com.jason.testSysUser.entity.SysUser;
import com.jason.testSysUser.mapper.SysUserMapper;
import com.jason.util.LocalJsonUtil;
 ...
 * Created by jason on 2021/10/12.
 */
@Controller
...
public class EasyExcelController {
    ...
    public void exportSysUserList(HttpServletResponse response) {
        try{
            ...
            setExcelRespPropByjason(response, fileName,ExcelTypeEnum.XLSX);
...
//        EasyExcel.read(fileName, SysUser.class, new IndexOrNameDataListener()).sheet().doRead();
     ...
     * 设置excel下载响应头属性
     */
    private void setExcelRespPropByjason(HttpServletResponse response, String rawFileName,ExcelTypeEnum fileType) throws UnsupportedEncodingException {
        //设置文件类型
        String contentType = "";

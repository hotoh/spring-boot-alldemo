...
import com.jason.annotation.Log;
import com.jason.domain.SysOperLog;
import com.jason.enums.BusinessStatus;
import com.jason.myException.BaseException;
import com.jason.service.AsyncLogService;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.jason.annotation.Log)")

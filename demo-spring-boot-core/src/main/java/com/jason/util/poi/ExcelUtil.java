package com.jason.util.poi;


import com.jason.annotation.Excel;
import com.jason.annotation.Excels;
import com.jason.text.Convert;
import com.jason.util.DateUtils;
import com.jason.util.file.FileTypeUtils;
import com.jason.util.file.ImageUtils;
import com.jason.util.reflect.ReflectUtils;
...
public class ExcelUtil<T>
{
    ...
    public List<T> importExcel(String sheetName, InputStream is,int startRow) throws Exception
    {
        ...
        if (rows > startRow)
        {
            ...
            // 获取表头
            Row heard = sheet.getRow(startRow);
